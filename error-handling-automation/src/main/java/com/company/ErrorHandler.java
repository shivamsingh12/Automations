...
public final class ErrorHandler {
    ...
    public boolean loadECP() throws Exception {
        ...
        try {
            File input = new File(configStrings.get("userHomeDataDir")+"\\ErrorHandler.xlsx");
    ...
    public boolean loadConfig() throws Exception {
        ...
        configStrings.put("userHomeDataDir",System.getProperty("user.home") + "\\ErrorHandlerFiles");
...
//        edgeOptions.addArguments("disable-gpu");
    ...
    public boolean createDirectories() throws Exception{
        ...
        try {
            ...
            if(!Files.exists(Paths.get(userHome+"\\ErrorHandlerFiles\\ErrorHandler.xlsx"))){
                Files.copy(Paths.get(userHome+"\\ErrorHandler.xlsx"),Paths.get(configStrings.get("userHomeDataDir")+"\\ErrorHandler.xlsx"), StandardCopyOption.REPLACE_EXISTING);
            }
            if(!Files.exists(Paths.get(userHome+"\\ErrorHandlerFiles\\links.xml"))){
...
//                        System.out.println(transaction.CTN+transaction.TRANSACTION_TYPE+transaction.ERROR);
...
//                    }
            ...
            System.out.println("State changed to stopped in ErrorHandler");
        }finally {
            errorHandler.setState(State.STOPPED);
            System.out.println("State changed to stopped in ErrorHandler");
        }
